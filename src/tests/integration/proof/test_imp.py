...
class TestImpProof(KCFGExploreTest, KProveTest):
    ...
    def test_execute(
        ...
        # When
        exec_res = kcfg_explore.cterm_symbolic.cterm_execute(self.config(kcfg_explore.kprint, k, state), depth=depth)
    ...
    def test_get_model(
        ...
        # When
        actual = kcfg_explore.cterm_symbolic.cterm_get_model(cterm_term)
    ...
    def test_implies(
        ...
        # When
        actual = kcfg_explore.cterm_symbolic.cterm_implies(antecedent_term, consequent_term)
    ...
    def test_assume_defined(
        ...
        # When
        actual = kcfg_explore.cterm_symbolic.cterm_assume_defined(config)

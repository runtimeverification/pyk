...
class TestSimpleProof(KCFGExploreTest):
    ...
    def test_execute(
        ...
        # When
        exec_res = kcfg_explore.cterm_symbolic.cterm_execute(self.config(kcfg_explore.kprint, *pre), depth=depth)
    ...
    def test_simplify(
        ...
        # When
        actual_post, _logs = kcfg_explore.cterm_symbolic.cterm_simplify(self.config(kcfg_explore.kprint, *pre))

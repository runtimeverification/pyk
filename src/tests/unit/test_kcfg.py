...
def node_dicts(n: int, start: int = 1) -> dict[int, str]:
    return {node(i).id: node(i).digest for i in range(start, start + n)}
...
#      # When
#      cfg = KCFG.from_dict(d)
#      cfg_dict1 = cfg.to_dict_summary()
#      cfg_dict2 = cfg.to_dict_summary()
#
#      # Then

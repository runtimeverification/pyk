    ...
    *,
    ...
    if start_server:
        ...
        with kore_server(
            ...
            with KoreClient('localhost', server.port, definition_dir, bug_report=bug_report, bug_report_id=id) as client:
        ...
        with KoreClient('localhost', port, definition_dir, bug_report=bug_report, bug_report_id=id, dispatch=dispatch) as client:
            yield CTermSymbolic(client, definition, kompiled_kore, trace_rewrites=trace_rewrites)

...
from ..konvert import KompiledKore, _ksort_to_kore, kast_to_kore_2, unmunge
...
class KPrint:
    ...
    def kast_to_kore(self, kast: KInner, sort: Optional[KSort] = None) -> Pattern:
        try:
            return kast_to_kore_2(self.kompiled_kore, kast, sort=_ksort_to_kore(sort) if sort else None)
